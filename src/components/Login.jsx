    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-700">Login in your account</h2>
        </div>
        ...
        <div className="flex items-center my-4">
          ...
          <span className="mx-2 text-gray-800 text-sm font-medium">or login with</span>
          <hr className="flex-grow border-gray-300" />
        </div>
        ...
        <div className="flex justify-center space-x-3 mb-4">
          <img
            src={search1}
            alt="Search1"
            className="w-8 h-8 cursor-pointer rounded-md hover:opacity-80 transition"
          />
          <img
            src={search2}
            alt="Search2"
